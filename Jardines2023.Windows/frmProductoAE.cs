...
namespace Jardines2023.Windows
{
    public partial class frmProductoAE : Form
    {
        ...
        {
            var _servicioCategorias = new ServiciosCategorias();
            frmCategoriaAE frm = new frmCategoriaAE(_servicioCategorias) { Text = "Agregar categoría" };
            ...
            CombosHelper.CargarComboPaises(ref cboCategorias);
        }
    }
}
